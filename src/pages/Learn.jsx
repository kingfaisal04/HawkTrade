              ...
              <section className="pt-6 border-t border-hawk-border">
                <div className="mb-6 flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-sm text-hawk-text-secondary mt-1">Connect with verified mentors and join the discussion.</p>
                  </div>
                </div>

                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                  {/* Community Card */}
                  <div className="glass rounded-xl p-5 border border-hawk-border hover:border-hawk-blue/50 transition-colors cursor-pointer group">
                    <div className="w-12 h-12 rounded-full bg-hawk-blue/20 flex items-center justify-center mb-4 group-hover:scale-110 transition-transform">
                      <Users className="w-6 h-6 text-hawk-blue" />
                    </div>
                    <h3 className="font-bold text-white mb-2">Global Trading Floor</h3>
                    <p className="text-sm text-hawk-text-secondary mb-4">Join 10,000+ traders sharing setups, market bias, and holding each other accountable.</p>
                    <button className="text-sm font-bold text-hawk-blue flex items-center">
                      Join Discord <ChevronRight className="w-4 h-4 ml-1" />
                    </button>
                  </div>

                  {/* Mentor 1 */}
                  <div className="glass rounded-xl p-5 border border-hawk-border hover:border-hawk-amber/50 transition-colors cursor-pointer group">
                    <div className="flex items-center gap-4 mb-4">
                      <div className="w-12 h-12 rounded-full bg-hawk-surface-2 border-2 border-hawk-amber overflow-hidden">
                        <img src="https://i.pravatar.cc/150?u=a042581f4e29026024d" alt="Mentor" className="w-full h-full object-cover" />
                      </div>
                      <div>
                        <h3 className="font-bold text-white">Sarah Jenkins</h3>
                        <p className="text-xs text-hawk-amber font-bold">Order Flow Specialist</p>
                      </div>
                    </div>
                    <p className="text-sm text-hawk-text-secondary mb-4">Weekly live tape reading sessions and DOM analysis deep dives.</p>
                    <button className="text-sm font-bold text-hawk-text-secondary group-hover:text-white flex items-center transition-colors">
                      View Profile <ChevronRight className="w-4 h-4 ml-1" />
                    </button>
                  </div>

                  {/* Mentor 2 */}
                  <div className="glass rounded-xl p-5 border border-hawk-border hover:border-hawk-purple/50 transition-colors cursor-pointer group">
                    <div className="flex items-center gap-4 mb-4">
                      <div className="w-12 h-12 rounded-full bg-hawk-surface-2 border-2 border-hawk-purple overflow-hidden">
                        <img src="https://i.pravatar.cc/150?u=a042581f4e29026704d" alt="Mentor" className="w-full h-full object-cover" />
                      </div>
                      <div>
                        <h3 className="font-bold text-white">Marcus Chen</h3>
                        <p className="text-xs text-hawk-purple font-bold">ICT / SMC Mentor</p>
                      </div>
                    </div>
                    <p className="text-sm text-hawk-text-secondary mb-4">Daily London killzone bias, synthetic liquidity models, and AMD setups.</p>
                    <button className="text-sm font-bold text-hawk-text-secondary group-hover:text-white flex items-center transition-colors">
                      View Profile <ChevronRight className="w-4 h-4 ml-1" />
                    </button>
                  </div>
