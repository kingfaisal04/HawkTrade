        ...
        <div className="page-container relative z-10 w-full flex-grow flex flex-col justify-center">
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-8 items-center mt-12">
            ...
            <div className="max-w-2xl animate-slide-up px-4 md:px-0 z-20">
              ...
              Find your edge, track prop firm challenges, and let Ai fix your leaks. 
              </p>
...
{/* ================= THE PROBLEM VS SOLUTION ================= */}
      ...
      <section className="py-20 border-y border-hawk-border bg-[#059669] relative overflow-hidden">
        ...
        <div className="page-container relative z-10 px-4 md:px-0">
          <div className="max-w-4xl mx-auto text-center">
            <h2 className="text-3xl md:text-4xl font-bold mb-6 text-black">Built by traders, <span className="text-black">for traders.</span></h2>
            ...
            <div className="inline-flex items-center gap-4 bg-hawk-surface/50 border border-hawk-border rounded-full px-6 py-3">
              ...
              <span className="text-sm font-medium text-black">Over 2.5 million trades analyzed across our platform.</span>
            </div>
          </div>
        </div>
      </section>
